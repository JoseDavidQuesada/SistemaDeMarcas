...
if(isset($_POST['user']) && isset($_POST['pass']) && isset($_POST['passConfirm'])){
    ...
    if($user == $validacion){
        ...
        $_SESSION['Ftipo'] = $tipo;
        $_SESSION['Ftelefono'] = $telefono;
        $_SESSION['Fcorreo'] = $correo;
        ...
        mysqli_query($conn, "CALL crearPerfil('$cedula','$nombre', '$apellido1', '$apellido2','$fechaNac','$telefono','$correo','img/users/$nameImg',$dCreador,'$user','$pass',$tipo)");                             
        mysqli_close($conn);  
