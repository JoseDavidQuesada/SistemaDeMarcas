...
<div>   
      <?php if (isset($_SESSION['tipo']) && $_SESSION['tipo'] == 2 ){  ?>
        ...
        <a href="perfil.php?id=2"><img src="img/usuario.svg" class="img-responsive" id="iconosHeader"><a> 


      <?php } else if (isset($_SESSION['tipo']) && $_SESSION['tipo'] == 1 ){  ?>
        <a onclick="confirmacionLogout()"><img src="img/logout.svg" class="img-responsive" id="iconosHeader"><a>
        <a href="perfil.php?id=1"><img src="img/usuario.svg" class="img-responsive" id="iconosHeader"><a>
      <?php }else { ?>
        <a onclick="confirmacionLogout()"><img src="img/logout.svg" class="img-responsive" id="iconosHeader"><a>
