...
<?php 
    ...
    if(!isset($_GET['log'])){
      ...
      $_SESSION['Ftipo'] = null;
      $_SESSION['Fuser'] = null;
      $_SESSION['Ftelefono'] = null;
      $_SESSION['Fcorreo'] = null;
    }
   
    if(isset($_SESSION['Ftelefono'])){
        $telefono = $_SESSION['Ftelefono']; 
    }else{
      $telefono = null;
   }
       if(isset($_SESSION['Fcorreo'])){
        $correo = $_SESSION['Fcorreo']; 
    }else{
      $correo = null;
   }
...
<div class="container">
  ...
  <form method="POST" id="crearPerfil" action="controlador/crearPerfil.php" role="form" enctype="multipart/form-data">
    ...
    <div class="card-body">
          ...
          <h3 style="text-align: center; padding-bottom: 35px;"> Creando perfil </h3>
    ...
    <div class="form-group">
      ...
      <input type="email" class="form-control"  name="correo" placeholder="Correo" value="<?php echo $correo; ?>" >
    </div>
    ...
    <h3 style="text-align: center; padding-bottom: 35px;"> Creando Usuario </h3>
