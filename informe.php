...
<div class="container">
  <div class="card-body">
      ...
      <div class="row">
            ...
            <div class="input-group input-daterange" style="width: 550px;">
            ...
            <div class="contendorButtons" style="width:400px">

            <div class="buttonInformes col">
            <button type="button" class="btn btn-secondary btn-sm"  onclick="location.href='home.php'" >Volver</button>  
            </div>
            ...
            <button type="submit" class="btn btn-secondary btn-sm">Limpiar</button>  
			       ...
			       <div class="buttonInformes col" >
            <button type="button" id="porMes" class="btn btn-primary btn-sm">Este mes</button>  
            </div>
            
            <div class="buttonInformes col" >
              <button type="button" id="porDia" class="btn btn-primary btn-sm" id="filtroHoy">Dia de hoy</button>  
            </div>
